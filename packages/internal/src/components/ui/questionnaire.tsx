...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-[1lh] w-fit min-w-[14ch] text-label-12-mono text-content-tertiary",
        className
      )}
      {...props}
    />
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "text-heading-14 text-pretty [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4",
        className
      )}
      {...props}
    />
...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      ...
      className={cn(
        "text-copy-13 text-pretty text-content-secondary",
        className
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none relative flex size-4 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-regular border border-divider-strong bg-surface-primary group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[type=radio]/questionnaire-choice:rounded-pill group-data-checked/questionnaire-choice:border-brand group-data-checked/questionnaire-choice:bg-brand group-data-checked/questionnaire-choice:text-content-inverse"
      >
        <span
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-4 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-small border border-divider bg-surface-primary text-label-12-mono text-content-tertiary group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  )
}
...
function QuestionnaireError({
  ...
  return (
    <QuestionnairePrimitive.Error
      ...
      className={cn("mt-2 text-label-13 text-status-danger", className)}
      {...props}
    />
  )
}
