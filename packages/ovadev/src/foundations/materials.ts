...
const cut = `8px 8px 0 rgba(0, 0, 0, 0.55)`;
...
export const SURFACE: Material[] = [
  ...
  { cls: "material-medium", name: "Medium", radius: 0, fill: "var(--ova-surface-secondary)", stroke: line, shadow: "none", use: "A cell lifted off the page: a band, a plate, a card that invites a click." },
  { cls: "material-large", name: "Large", radius: 0, fill: "var(--ova-surface-secondary)", stroke: line, shadow: cut, use: "The one thing on the page that must be found first: lifted, and cut." },
];
...
export const FLOATING: Material[] = [
  ...
  { cls: "material-menu", name: "Menu", radius: 0, fill: "var(--ova-surface-secondary)", stroke: edge, shadow: cut, use: "Menus, popovers, comboboxes: a lifted surface, the strong hairline, the cut." },
  { cls: "material-modal", name: "Modal", radius: 0, fill: "var(--ova-surface-secondary)", stroke: edge, shadow: cut, use: "Dialogs and sheets." },
