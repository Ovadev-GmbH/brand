  ...
  return (
    ...
    >
      <select
        ...
        data-size={size}
        className="h-8 w-full min-w-0 appearance-none rounded-regular border border-divider-strong bg-surface-primary py-1 pr-8 pl-2.5 text-label-13 transition-[color,background-color,border-color,box-shadow,transform] duration-fast ease-brand outline-none select-none selection:bg-brand selection:text-content-inverse placeholder:text-content-tertiary focus-visible:ring-1 focus-visible:ring-brand-bright disabled:pointer-events-none disabled:cursor-not-allowed aria-invalid:ring-1 aria-invalid:ring-status-danger data-[size=sm]:h-7 data-[size=sm]:rounded-regular data-[size=sm]:py-0.5"
        {...props}
      />
