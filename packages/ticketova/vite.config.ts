...
// a second entry, published as the ./icons subpath, and icons-ssr.ts its
// server-component twin as ./icons/ssr; blocks.ts the screens composed from
  ...
  build: {
    lib: {
      entry: {
        ...
        "icons-ssr": resolve(import.meta.dirname, "src/icons-ssr.ts"),
