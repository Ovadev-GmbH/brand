...
export const SEMANTIC: SemanticGroup[] = [
  {
    ...
    tokens: [
      ...
      { token: "surface-quaternary", ref: ref("gray", 400), use: "The deepest step: a code block, a well inside a well." },
      { token: "surface-hover", ref: ref("gray-alpha", 100), use: "A row, option or button under the pointer: the ink at 5%, so it reads as shade, not as a colour." },
      { token: "surface-active", ref: ref("gray-alpha", 200), use: "The selected row, the pressed toggle, the current page: the ink at 8%." },
