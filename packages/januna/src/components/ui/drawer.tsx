...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-copy-14 text-balance text-content-secondary", className)}
      {...props}
    />
  )
}
