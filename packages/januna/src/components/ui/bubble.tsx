  ...
  "group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
        ...
        secondary:
          "*:data-[slot=bubble-content]:bg-surface-tertiary *:data-[slot=bubble-content]:text-content-primary [&>[data-slot=bubble-content]:is(button,a):hover]:bg-surface-quaternary",
        muted:
          "*:data-[slot=bubble-content]:bg-surface-secondary [&>[data-slot=bubble-content]:is(button,a):hover]:bg-surface-hover",
        tinted:
          "*:data-[slot=bubble-content]:bg-brand-subtle *:data-[slot=bubble-content]:text-content-primary [&>[data-slot=bubble-content]:is(button,a):hover]:bg-green-300",
        outline:
