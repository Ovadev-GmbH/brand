...
// A ring that shows how much of something is used: covers tonight, tables
// seated. The primary arc grows clockwise from twelve; the rest is the track.
// The colour follows the value by default (grey, blue, amber, green as it
...
const TRACK = "var(--jan-gray-alpha-200)"

const DEFAULT_COLORS: Record<string, string> = {
  "0": "var(--jan-gray-500)",
  "14": "var(--jan-blue-700)",
  "34": "var(--jan-amber-700)",
  "68": "var(--jan-green-700)",
}
