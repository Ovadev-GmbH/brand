...
export default {
  description:
    "A small secondary line that annotates what sits around it: a sync time under a table, a day between messages, a publish that is still running. A state of its own belongs in a [Badge](/ovadev/badge) with its word.",
  usage: `<Marker>
