...
export default {
  description:
    "A row that shows one thing and offers one or two actions on it: an API key with Rotate, an environment with its status, a pending invitation. For many rows with the same columns, use a [Table](/ticketova/table).",
...
└── ItemSeparator`,
  sections: [
    ...
    {
      title: "Item or Field",
      text: "An Item shows something and acts on it. When the control is the value itself, a switch or a checkbox, use a horizontal [Field](/ticketova/field), so its label is tied to the control.",
    },
  ],
  api: [
    {
