...
export default {
  description:
    "Tells the Base UI components inside it which way text reads, so their arrow keys, sliders and popup sides follow a right-to-left layout. It renders nothing and sets no attribute of its own.",
  ...
  <div dir={direction}>{children}</div>
    ...
    {
      title: "useDirection",
      text: 'For a component of your own, `useDirection` returns the nearest provider\'s value: here a chevron that must point the way the reading goes.',
  ...
  api: [
    {
      ...
      text: 'Base UI\'s Direction Provider as it is. `direction` takes `"ltr"` or `"rtl"` and defaults to `"ltr"`.',
    },
    {
      name: "useDirection",
