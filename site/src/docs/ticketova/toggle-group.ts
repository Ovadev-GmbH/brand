...
export default {
  description:
    "A row of toggles whose pressed items are the current choice: a time range, an environment, the log levels to show. For actions that do not stay pressed, use [Button Group](/ticketova/button-group).",
