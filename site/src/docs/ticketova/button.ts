...
export default {
  ...
  sections: [
    ...
    {
      title: "Destructive",
      text: "Red on a faint red fill, for what cannot be undone. Confirm it in an [Alert Dialog](/ticketova/alert-dialog) before it runs.",
      example: "destructive",
    },
    ...
    {
      title: "Button Group",
      text: "Buttons that act on the same thing sit in a `ButtonGroup`, which joins their edges. See [Button Group](/ticketova/button-group).",
      example: "group",
    },
    {
      title: "As Link",
