...
export default {
  description:
    "Turns one setting on or off, and the change applies at once: maintenance mode, auto-deploy, dunning e-mails. When the choice only counts after a Save, use [Checkbox](/ticketova/checkbox).",
