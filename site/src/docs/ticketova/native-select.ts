...
export default {
  description:
    "The browser's own `<select>`, styled to match. It opens the platform's picker, which is what a phone should show. When options need icons, descriptions or search, use [Select](/ticketova/select) or [Combobox](/ticketova/combobox).",
