...
export default {
  description:
    "A number chosen by dragging along a range, where the position says more than the digits: replicas, a retention window, a rate limit. Show the exact figure beside it, or use an [Input](/ticketova/input) when people will type it.",
