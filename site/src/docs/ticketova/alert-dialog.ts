...
export default {
  description:
    "A question that has to be answered before anything else happens, for an action that cannot be undone: revoking a key, voiding an invoice, deleting a tenant. For a task with fields, use [Dialog](/ticketova/dialog).",
  usage: `<AlertDialog>
