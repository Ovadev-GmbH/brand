...
export default {
  description:
    "An input with something inside its edge: an icon, a unit, a button, a shortcut. For separate controls that only touch, use [Button Group](/ticketova/button-group).",
  usage: `<InputGroup>
