...
export default {
  description:
    "A text field that filters a list as you type, for picking from more options than a menu can show: tenants, team members, time zones. For a short list known in advance, use [Select](/ticketova/select).",
