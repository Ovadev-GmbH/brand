...
export default {
  description:
    "Work that has started and has no measurable end yet: a request, a refresh, a check. When the end is known, show [Progress](/ticketova/progress); when the shape of the content is known, a [Skeleton](/ticketova/skeleton).",
  usage: `<Spinner />`,
  sections: [
    {
      title: "Size",
    ...
    {
      title: "Button",
      text: 'Disable the button while the action runs and put the spinner where its icon would be, marked `data-icon="inline-start"`. See [Button](/ticketova/button).',
      example: "button",
    },
    {
      title: "Badge",
