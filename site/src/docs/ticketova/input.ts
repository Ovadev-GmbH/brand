...
export default {
  ...
  sections: [
    ...
    {
      title: "Input Group",
      text: "Text, icons or buttons inside the input's edge go in an `InputGroup`. See [Input Group](/ticketova/input-group).",
      example: "input-group",
    },
    {
      title: "Button Group",
      text: "An input and a button that act together sit in a `ButtonGroup`. See [Button Group](/ticketova/button-group).",
