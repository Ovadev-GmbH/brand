...
export default {
  description:
    "Recharts, drawn in the system's ink: a trend over time, or how a total splits. When the operator needs the exact figure rather than the shape, use a [Table](/ticketova/table).",
  usage: `const config = {
