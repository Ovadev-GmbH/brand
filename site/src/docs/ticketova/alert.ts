...
export default {
  description:
    "A note in the flow of the page that stays until its cause is gone: a maintenance window, a failed payment, a key about to expire. For news about something the operator just did, use a [Toast](/ticketova/toast).",
  usage: `<Alert>
