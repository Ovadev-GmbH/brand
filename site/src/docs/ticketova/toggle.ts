...
export default {
  description:
    "A button that stays pressed until it is pressed again: follow a log, watch an incident, show archived rows. For one choice among several, use [Toggle Group](/ticketova/toggle-group).",
