...
export default {
  description:
    "The main sections of a site in a row, each opening a panel with the pages inside it. For actions rather than places, use [Menubar](/ticketova/menubar) or [Dropdown Menu](/ticketova/dropdown-menu).",
