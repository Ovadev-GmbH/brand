...
export default {
  description:
    "A small panel that opens from a button and holds a few details or controls for it: a filter, a limit, a note on a term. For a preview on hover use [Hover Card](/ticketova/hover-card); for a task that needs full attention, [Dialog](/ticketova/dialog).",
  usage: `<Popover>
