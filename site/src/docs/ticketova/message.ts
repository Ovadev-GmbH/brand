...
export default {
  description:
    "One entry in a conversation: who wrote it, what they wrote and when. It places the avatar, a header, the content and a footer on the sender's side; the content is usually a [Bubble](/ticketova/bubble).",
  usage: `<Message>
  <MessageContent>
...
└── Message
  ...
  sections: [
    ...
    {
      title: "Attachment",
      text: "An [Attachment](/ticketova/attachment) goes in `MessageContent` next to the bubble and keeps to the row's side.",
      example: "attachment",
    },
  ],
  api: [
