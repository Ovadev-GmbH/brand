...
export default {
  description:
    "A short label for a control that has none of its own, or the exact value behind a shortened one: an icon button's name, a relative time's timestamp. For anything longer, or anything to click, use [Popover](/ticketova/popover).",
  usage: `<Tooltip>
