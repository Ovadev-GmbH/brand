...
export default {
  description:
    "A small secondary line that annotates what sits around it: a sync time under a table, a day between audit events, a deployment that is still rolling out. A state of its own belongs in a [Badge](/ticketova/badge) with its word.",
  usage: `<Marker>
