...
export default {
  description:
    "A list of actions or options behind a button: a row's actions, a table's columns, the account. To choose one value in a form use [Select](/ticketova/select); for actions on right-click, [Context Menu](/ticketova/context-menu).",
  usage: `<DropdownMenu>
...
└── DropdownMenuContent
  ...
  sections: [
    ...
    {
      title: "Destructive",
      text: '`variant="destructive"` turns the item red. Put it last, after a separator, and confirm it in an [Alert Dialog](/ticketova/alert-dialog).',
      example: "destructive",
    },
  ],
  api: [
