...
export default {
  description:
    "A row of slides moved with buttons, swipes or the arrow keys, for a few large things seen one or three at a time. Rows of records that should be compared belong in a [Table](/ticketova/table).",
  usage: `<Carousel>
  <CarouselContent>
