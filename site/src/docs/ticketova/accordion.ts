...
export default {
  description:
    "Sections of one record or document that open in place, so a long page is read a part at a time: a runbook, a postmortem, a tenant's settings. For a single section use [Collapsible](/ticketova/collapsible); for views that replace each other, [Tabs](/ticketova/tabs).",
