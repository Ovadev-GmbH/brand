...
export default {
  description:
    "The name of a control, tied to it with `htmlFor` so a click on the words focuses or toggles it. In a form, [Field](/ticketova/field) uses it as `FieldLabel` and adds the description and the error.",
...
<Input id="tenant-slug" />`,
  sections: [
    ...
    {
      title: "Field",
      text: "In a form, use `FieldLabel` in a `Field`: the same label, spaced with the control, its description and its error. See [Field](/ticketova/field).",
      example: "field",
    },
  ],
  api: [
