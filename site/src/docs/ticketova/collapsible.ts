...
export default {
  description:
    "A section that opens and closes under its own trigger: the older runs of a pipeline, the advanced options of a form. For a stack of sections whose headings list what is inside, use [Accordion](/ticketova/accordion).",
  usage: `<Collapsible>
