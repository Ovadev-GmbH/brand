...
export default {
  description:
    "A row of menus for a workspace with many commands, the way a desktop application has one: an editor, a console, a log viewer. A page with a handful of actions needs a [Dropdown Menu](/ticketova/dropdown-menu) instead.",
  usage: `<Menubar>
  <MenubarMenu>
