...
export default {
  description:
    "The navigation column of a tool: its sections, their pages and counts, collapsing to icons or off the edge. For a few views of one record, use [Tabs](/ticketova/tabs).",
...
>`,
    ...
    {
      title: "Mobile",
      text: "Below 768px the sidebar leaves the layout and opens as a [Sheet](/ticketova/sheet) from its `side` when `SidebarTrigger` is pressed. `useSidebar` reports this as `isMobile`, with `openMobile` as its own state.",
    },
    {
      title: "Controlled",
