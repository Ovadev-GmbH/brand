...
export default {
  description:
    "A panel that slides over the page from one edge, for a record's details or an edit where the list behind should stay in mind. For a short task in the middle of the screen, use [Dialog](/ticketova/dialog); for touch, [Drawer](/ticketova/drawer).",
  usage: `<Sheet>
