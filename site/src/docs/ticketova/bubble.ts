...
export default {
  description:
    "The framed text of one message, as wide as its content and at most 80% of the row. Put it in a [Message](/ticketova/message) for the sender, the avatar and the time.",
