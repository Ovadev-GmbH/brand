...
export default {
  description:
    "Actions on the thing under the pointer, opened with a right-click or a long press. Nobody sees the menu before it opens, so offer the same actions somewhere visible too, such as a [Dropdown Menu](/ticketova/dropdown-menu) in the row.",
  usage: `<ContextMenu>
