...
export default {
  description:
    "A hairline box around one self-contained thing: a settings panel, a tenant's summary, a destructive action set apart. A list of records is a [Table](/ticketova/table), not a grid of cards.",
  usage: `<Card>
  <CardHeader>
