  ...
  return (
    <div className="grid max-w-[640px] gap-4">
      <div className="flex items-center gap-3">
        ...
        <Label htmlFor="online-bookings">
          Online bookings {online ? "open" : "paused"}
        </Label>
      </div>
      ...
      <div className="flex items-center gap-3">
        <Switch id="invalid" aria-invalid />
        <Label htmlFor="invalid">Auto-confirm walk-ins</Label>
      </div>

      <div className="flex items-center gap-3">
        <Switch id="disabled" disabled defaultChecked />
        <Label htmlFor="disabled">Terrace seating (closed for the season)</Label>
      </div>
    </div>
  );
}
