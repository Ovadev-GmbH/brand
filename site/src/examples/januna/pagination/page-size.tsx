...
const total = 1204;
/* The Swiss thousands separator: 1'204. */
const count = (value: number) => String(value).replace(/\B(?=(\d{3})+(?!\d))/g, "'");
    ...
    <div className="flex w-full max-w-xl flex-wrap items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3">
        <span className="text-label-13-mono text-content-secondary">
          1 to {count(perPage)} of {count(total)}
        </span>
