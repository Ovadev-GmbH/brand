  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <Pagination>
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious href={`#pagination-page-${page - 1}`} onClick={go(page - 1)} />
          </PaginationItem>
          {pages.map((p, i) => (
            <React.Fragment key={p}>
              ...
              <PaginationItem>
                <PaginationLink href={`#pagination-page-${p}`} isActive={p === page} onClick={go(p)}>
                  {p}
                </PaginationLink>
              </PaginationItem>
            </React.Fragment>
          ...
          <PaginationItem>
            <PaginationNext href={`#pagination-page-${page + 1}`} onClick={go(page + 1)} />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
      <span className="text-label-13 text-content-secondary">
        Past bookings, page <span className="text-label-13-mono">{page}</span> of{" "}
