...
import { FileZipIcon, FileXlsIcon, FileTextIcon } from "@ovadev-gmbh/ui-ticketova/icons";

const files = [
  { name: "INV-2026-0142.pdf", size: "84 KB", icon: FileTextIcon },
  { name: "seats-2026-09.csv", size: "12 KB", icon: FileXlsIcon },
  { name: "contract-bergwerk-ag.pdf", size: "1.2 MB", icon: FileTextIcon },
  { name: "d-8f3a21c-logs.zip", size: "2.3 MB", icon: FileZipIcon },
  { name: "usage-2026-08.csv", size: "48 KB", icon: FileXlsIcon },
];
