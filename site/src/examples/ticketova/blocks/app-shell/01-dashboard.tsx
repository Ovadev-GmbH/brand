...
import type { ChartConfig } from "@ovadev-gmbh/ui-ticketova";
import { AppShell, AppShellContent, AppShellHeader, Stat, StatGrid } from "@ovadev-gmbh/ui-ticketova/blocks";
import { BuildingsIcon, DownloadSimpleIcon, FileMinusIcon, KeyIcon, SquaresFourIcon, ReceiptIcon, RocketIcon, ScrollIcon, WarningIcon } from "@ovadev-gmbh/ui-ticketova/icons";

const nav = [
  {
    label: "Operations",
    items: [
      { title: "Overview", icon: SquaresFourIcon, href: "/", active: true },
      { title: "Tenants", icon: BuildingsIcon, href: "/tenants" },
      { title: "Deployments", icon: RocketIcon, href: "/deployments" },
      { title: "Incidents", icon: WarningIcon, href: "/incidents", badge: "2" },
    ],
  },
  {
    label: "Billing",
  ...
  },
  {
    label: "Access",
    items: [
      { title: "API keys", icon: KeyIcon, href: "/api-keys" },
      { title: "Audit log", icon: ScrollIcon, href: "/audit" },
    ],
  },
];
