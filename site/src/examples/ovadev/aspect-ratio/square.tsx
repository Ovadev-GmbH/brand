  ...
  return (
    <figure className="flex w-40 flex-col gap-2">
      <AspectRatio ratio={1} className="bg-surface-secondary">
        <div className="flex size-full items-center justify-center text-heading-24 text-content-secondary">O</div>
      </AspectRatio>
      <figcaption className="flex items-center justify-between gap-2">
        <span className="text-label-12-mono">ovadev-mark.png</span>
