...
const api = [
  ...
  `### Components`, ``,
  `${components.length} components on Base UI. Each is documented with a live demo and its source at ${SITE}/${ID}/<slug>, and as Markdown at the same path with \`.md\`. The exported names are the parts you compose.`, ``,
  ...(() => {
